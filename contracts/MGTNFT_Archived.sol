...
contract MGTNFT_Archived is ERC721, Ownable {
    ...
    uint64 public immutable maxSupply = 1270;
    uint64 public saleAmount;
    uint64 public totalSupply;

    bool public publicTrigger;
    ...
    function publicMint(uint64 amount) external payable callerIsUser {
        require(publicTrigger, "public mint is not open");
        require(msg.value >= price * amount, "Insufficient value");
